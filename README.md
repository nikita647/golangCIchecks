...
|------------|----------------|-------------|----------------|-----------------|-------------|-------------|
| Aayush Verma|   02-04-2025        | V1  | Aayush Verma   |02-04-2025     |  L0 | Akshit Kapil | 
| Aayush Verma|   02-04-2025  | v1          | Aayush Verma   | 02-04-2025   |  Internal Reviewer | Siddharth |
...
|-------------|----------------|-----------|------------|------------------|------------|
| 100         | SSH (22)       | TCP (6)   | 22         | 198.168.0.0/28   | Allow      |
| 120         | Custom TCP     | TCP (6)   | 3000       | 198.168.0.0/28   | Allow      |
| 130         | HTTPS (443)    | TCP (6)   | 1024 - 65535 | 0.0.0.0/0   | Allow      |
...
| 200         | Custom TCP     | TCP (6)   |8080      | 192.168.0.64/27   | Allow      |
| *           | All traffic    | All       | All              | 0.0.0.0/0         | Deny       |
...
| 110         | Custom TCP| TCP      | 8080       | 192.168.0.0/28 | Allow      |
| 110         | Custom TCP| TCP      | 8080       | 192.168.0.16/28 | Allow      |
| *           | All traffic | All     | All        | 0.0.0.0/0    | Deny       |
...
| Rule Number | Type           | Protocol  | Port Range       | Destination        | Allow/Deny |
|-------------|----------------|-----------|------------------|--------------------|------------|
| 90          | Custom TCP     | TCP (6)   | 1024 - 65535     | 192.168.0.64/27    | Allow      |
| 100         | SSH (22)       | TCP (6)   | 22               | 192.168.0.0/28     | Allow      |
